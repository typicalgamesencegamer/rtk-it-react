        ...
        try {
            ...
            return new Promise((resolve, reject) => {
                client.connect(headers, (frame) => {
                    ...
                    client.subscribe('/topic/subscribe-actual-info', (message) => {
                        try {
...
const transformPredictionData = (predictionData) => {
    ...
    return {
        activeRobots: predictionData.active_robots, // Временные данные
        totalRobots: predictionData.total_robots,
        scannedToday: predictionData.total_checked_locations || 0,
        criticalStock: predictionData.critical_items_count,
        averageBattery: predictionData.avg_battery_level,
    };
};