...
//     { id: `${allRobots[0].id}`, x: 15 + allRobots[0].current_row * 30, y: 15 + allRobots[0].current_shelf * 30, battery: allRobots[0].battery_level, status: `${allRobots[0].status}`, lastUpdate: `${allRobots[0].last_update}` },
//     { id: `${allRobots[1].id}`, x: 15 + allRobots[1].current_row * 30, y: 15 + allRobots[1].current_shelf * 30, battery: allRobots[1].battery_level, status: `${allRobots[0].status}`, lastUpdate: `${allRobots[1].last_update}` },
//     { id: `${allRobots[2].id}`, x: 15 + allRobots[2].current_row * 30, y: 15 + allRobots[2].current_shelf * 30, battery: allRobots[2].battery_level, status: `${allRobots[0].status}`, lastUpdate: `${allRobots[2].last_update}` },
//     { id: `${allRobots[3].id}`, x: 15 + allRobots[3].current_row * 30, y: 15 + allRobots[3].current_shelf * 30, battery: allRobots[3].battery_level, status: `${allRobots[0].status}`, lastUpdate: `${allRobots[3].last_update}` },
//     { id: `${allRobots[4].id}`, x: 15 + allRobots[4].current_row * 30, y: 15 + allRobots[4].current_shelf * 30, battery: allRobots[4].battery_level, status: `${allRobots[0].status}`, lastUpdate: `${allRobots[4].last_update}` },
//   ]);

//   // id, status, battery_level, last_update, current-zone, row,  shelf
